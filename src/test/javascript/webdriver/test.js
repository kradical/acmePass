...
describe.only('Listing ACMEPass passwords', function () {
    ...
    const sortByLastModitifiedDate = 'body > div:nth-child(3) > div > div > div.table-responsive > table > thead > tr > th:nth-child(4)'

    // Sorting Symbols Selectors
    const sortAZ = 'span.glyphicon.glyphicon-sort-by-attributes-alt'
    const sortZA = 'span.glyphicon.glyphicon-sort-by-attributes'
    ...
    it('it creates an ACMEPass', function () {
        return client
            ...
            .click(saveAcmePassButton)
            // .waitForExist(thirdRow, 1000).then(function() {
            //     assert(false, "Failed to create 3 ACMEPasses")
            // })
    })

    //Sort by ID
    it('it sorts list by ID', function () {
        return client
            .waitForExist(sortByID)
            .click(sortByID)
            ...
            .isExisting(sortByID + ' > ' + sortAZ).then( function () {
                ...
                console.log("===============")
                console.log(thirdId)
                assert(firstId < secondId && secondId < thirdId, 'Failed to sort list by ID correctly');
            })
            // .waitForExist(sortByID)
            // .click(sortByID)
            // .isExisting(sortByID + ' > ' + sortZA).then(function (text) {
    ...
    // //Sort by ID
    // it('it sorts list by Site', function () {
    //     return client
    //         .waitForExist(sortBySite)
    //         .click(sortBySite)
    // })
    //
    // //Sort by Login
    // it('it sorts list by Login', function () {
    //     return client
    //         .waitForExist(sortByLogin)
    //         .click(sortByLogin)
    // })
    //
    // //Sort by Password
    // it('it sorts list by Password', function () {
    //     return client
    //         .waitForExist(sortByPassword)
    //         .click(sortByPassword)
    // })
    //
    // //Sort by Created Date
    // it('it sorts list by Created Date', function () {
    //     return client
    //         .waitForExist(sortByCreatedDate)
    //         .click(sortByCreatedDate)
    // })
    //
    // //Sort by Last Modified Date
    // it('it sorts list by Last Modified Date', function () {
    //     return client
    //         .waitForExist(sortByLastModitifiedDate)
    //         .click(sortByLastModitifiedDate)
    // })
